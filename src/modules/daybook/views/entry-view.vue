<template>
  <div
    ...
    <div>
        <span class="text-succes fs-3 fw-bold">20</span>
  ...
  <img src="https://cardbiss.com/wp-content/uploads/2022/11/maxresdefault-30.jpg" alt="entry-picture" class="img-thumbnail">
...
export default {
    ...
    components:{
        Fab: defineAsyncComponent( () => import('../components/fab-btn.vue') )
    }
